...
async def run1_Mondiala():
    ...
    await gyroFata(50, 500, -26, stop=False)
    await gyroFata(16, 200)
    await runloop.sleep_ms(500)
    await motor.run_for_degrees(hub.port.C, -500, 400)
    await gyroFata(7, 200)
    await runloop.sleep_ms(500)
    await gyroSpate(70, 1000, 250)
    #sfarsit modificat
    return
...
async def run2_Mondiala():
    ...
    #inceput modificat
    print("Run 2")
    await gyroFata(80, 800, 180, stop = False)
...
async def run3_Mondiala():
    ...
    #inceput modificat
    print("Run 3")
    await gyroFata(51.5, 800, kp = 0.2, kd = 0.2)
    await runloop.sleep_ms(200)
    await turnRight(43.5, 1000, 100, resetGyro=False, kp = 0.1, kd = 0)
    await gyroFata(31, 350, kp = 0.2, kd = 0.3)
    await runloop.sleep_ms(200)
    await turnRight(43.5, 450, 100, resetGyro=False, kp = 0.1, kd = 0)
    await gyroFata(42, 800, kp = 0.2, kd = 0.3)
    await runloop.sleep_ms(200)
    await turnRight(85, 400, 100, resetGyro=False, kp = 0.075, kd = 0)
    await gyroFata(9, 250, kp = 0.2, kd = 0.3)
    await motor.run_for_degrees(hub.port.A, 485, 1000)

    await gyroSpate(15, 250, kp = 0.2, kd = 0.3)
    await turnLeft(85, 400, 100, resetGyro=False, kp = 0.01, kd = 0.1)
    await gyroFata(10.5, 250, kp = 0.2, kd = 0.3)
    await motor.run_for_degrees(hub.port.C, 75, 1000)

    await runloop.sleep_ms(50)

    await turnRight(40, 500, 100, resetGyro=False, kp = 0.025, kd = 0) #
    await gyroFata(10, 250) #
    await turnLeft(40, 500, 100, resetGyro=False, kp = 0.08, kd = 0)
    await gyroFata(7.5, 500, stop = False)
    await gyroFata(100, 800, 225)
    #sfarsit modificat
    return
...
async def run5_Mondiala():
    ...
    await gyroFata(33, 750, stop = False, resetGyro = False, kp = 0.6, kd = 0.3)
    await turnLeft(40, 500, 150, resetGyro = False, kp = 0.01, kd = 0)
    await runloop.sleep_ms(100)
    await gyroFata(16, 750, stop = True, kp = 0.8, kd = 0.3)
    await gyroFata(7.5, 375, stop = False, resetGyro = False, kp = 0.8, kd = 0.3)
    await gyroFata(6, 150, resetGyro = False, kp = 0.8, kd = 0.3)

    await runloop.sleep_ms(250)
    await turnRight(85, 750, 150, kp = 0.01, kd = 0)
    await runloop.sleep_ms(250)

    await gyroFata(20, 750, kp = 0.2, kd = 0.3)
    await runloop.sleep_ms(250)
    await gyroSpate(7.5, 1000, kp = 0.2, kd = 0.3)
    await turnLeft(70, 500)
    await gyroSpate(75, 1000, kp = 0.2, kd = 0.3)
    #sfarsit modificat
    return
...
async def run6_Mondiala():
    ...
    await turnRight(20, 500, 100, kp = 0.02, kd = 0)
    await gyroFata(120, 1000, -220, kp = 0.2, kd = 0.3)
    #sfarsit modificat
    return
...
async def run8_Mondiala():
    ...
    motor.run_for_degrees(hub.port.A, -360, 1000)
