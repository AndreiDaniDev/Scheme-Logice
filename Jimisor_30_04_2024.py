...
async def run3_Mondiala():
    ...
    await gyroSpate(12, 250, kp = 0.2, kd = 0.3)
...
async def run5_Mondiala():
    ...
    await gyroFata(39, 750, stop = False, kp = 0.2, kd = 0.3)
    await turnLeft(35, 250, 150, resetGyro = False, kp = 0.025, kd = 0)
    await gyroFata(10, 750, stop = True, kp = 0.2, kd = 0.3)
    await gyroFata(9, 375, stop = False, resetGyro = False, kp = 0.2, kd = 0.3)
    await gyroFata(8, 150, resetGyro = False, kp = 0.2, kd = 0.3)
    
    await runloop.sleep_ms(500)
    await turnRight(90, 350, 100, kp = 0.03, kd = 0)
...
async def run6_Mondiala():
    ...
    await gyroFata(110, 1000, -200, kp = 0.2, kd = 0.3)
    #sfarsit modificat
    return
