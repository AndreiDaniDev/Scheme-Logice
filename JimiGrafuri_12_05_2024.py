...
async def run3_Mondiala():
    ...
    #inceput modificat
    print("Run 3")
    await gyroFata(51, 800)
    await runloop.sleep_ms(200)
    await turnRight(44, 450, 100, resetGyro=False, kp = 0.1, kd = 0)
    await gyroFata(32.5, 350)
    await runloop.sleep_ms(200)
    await turnRight(44, 450, 100, resetGyro=False, kp = 0.1, kd = 0)
    await gyroFata(41, 800, kp = 0.2, kd = 0.3)
    await runloop.sleep_ms(200)
...
async def run5_Mondiala():
    ...
    await gyroFata(30, 750, stop = False, resetGyro = False,kp = 0.2, kd = 0.3)
    await turnLeft(29, 250, 150, resetGyro = False, kp = 0.02, kd = 0)
    await gyroFata(14, 750, stop = True, kp = 0.2, kd = 0.3)
    await gyroFata(10, 375, stop = False, resetGyro = False, kp = 0.2, kd = 0.3)
    await gyroFata(10, 150, resetGyro = False, kp = 0.2, kd = 0.3)

    await runloop.sleep_ms(500)
    await turnRight(84, 350, 150, kp = 0.03, kd = 0)
