...
async def run1_Mondiala():
    ...
    await gyroFata(50, 500, -25, stop=False)
...
async def run3_Mondiala():
    ...
    await gyroFata(41.75, 800, kp = 0.2, kd = 0.3)
    await runloop.sleep_ms(200)
    ...
    await gyroFata(11.5, 250, kp = 0.2, kd = 0.3)
...
async def run5_Mondiala():
    ...
    await gyroFata(45, 750, kp = 0.4, kd = 0.25, resetGyro = False)
    await runloop.sleep_ms(250)
    await turnLeft(43.5, 750, 125, kp = 0.75, kd = 1)
    await runloop.sleep_ms(250)

    # ---> Comanda de 2 lei <---
    await gyroFata(4.5, 500, kp = 0.3, kd = 0.25, stop = False)
    await gyroFata(16.5, 1000, kp = 0.3, kd = 0.25, resetGyro = False, stop = False)
    await gyroFata(3, 250, kp = 0.3, kd = 0.25, resetGyro = False)
    ...
    await motor.run_for_degrees(hub.port.C, 300, 1100)
    await runloop.sleep_ms(250)
    await gyroFata(14, 500, target = 37, kp = 0.4, kd = 0.25)
    await gyroFata(7.5, 500, kp = 0.4, kd = 0.25)
    await runloop.sleep_ms(250)
    await gyroSpate(14.5, 500, kp = 0.4, kd = 0.25)

    await turnLeft(70, 500, 250, kp = 0.4, kd = 0.25)
