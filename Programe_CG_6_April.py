import runloop, hub, motor, motor_pair, color, time
...
async def run5_Mondiala():
    ...
    await gyroFata(12.5, 1000, stop = False)
    await gyroFata(45, 1000, -500)

    await turnRight(65, 500, 200, kp = 0.08, kd = 0)
    await gyroFata(20, 1000)
    
    await gyroSpate(1, 200)
    await gyroFata(3, 1000)

    await runloop.sleep_ms(250)
    await gyroSpate(10, 500)
    await turnLeft(50, 500, 200, kp = 0.07, kd = 0)
    await gyroSpate(60, 1000)
    #sfarsit modificat
    return
...
async def run8_Mondiala():
    ...
    #inceput modificat 
    motor.run_for_degrees(hub.port.A, 500, 1000)
    await gyroFata(25, 500)
    await turnLeft(12.5, 500, 200, kp = 0.07, kd = 0.1)
    await gyroFata(37, 500)

    await runloop.sleep_ms(250)

    await turnLeft(50, 400, 175, kp = 0.07, kd = 0)
    await gyroFata(40, 600)
    motor.run_for_degrees(hub.port.A, 500, -1000)
