...
async def run3_Mondiala():
    ...
    await gyroSpate(13, 250, kp = 0.2, kd = 0.3)
    await turnLeft(85, 400, 100, resetGyro=False, kp = 0.01, kd = 0.1)
    await gyroFata(12, 250, kp = 0.2, kd = 0.3)
...
async def run5_Mondiala():
    ...
    await gyroFata(32, 750, stop = False, resetGyro = False,kp = 0.2, kd = 0.3)
    await turnLeft(34, 250, 150, resetGyro = False, kp = 0.02, kd = 0)
    await gyroFata(10, 750, stop = True, kp = 0.2, kd = 0.3)
    await gyroFata(10, 375, stop = False, resetGyro = False, kp = 0.2, kd = 0.3)
    await gyroFata(8.5, 150, resetGyro = False, kp = 0.2, kd = 0.3)
    
    await runloop.sleep_ms(500)
    await turnRight(90, 350, 150, kp = 0.03, kd = 0)
    
    await runloop.sleep_ms(250)
    await gyroFata(17, 750, kp = 0.2, kd = 0.3)
    await runloop.sleep_ms(250)
